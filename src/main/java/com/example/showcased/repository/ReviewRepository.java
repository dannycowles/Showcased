...
public interface ReviewRepository extends JpaRepository<Review, ReviewId> {
    ...
    @Query("SELECT new com.example.showcased.dto.ReviewWithUserInfoDto(r.reviewId, u.username, u.profilePicture, r.id.reviewerId, r.id.showId, r.showTitle, r.rating, r.commentary, r.containsSpoilers, r.numLikes, r.reviewDate, false) " +
